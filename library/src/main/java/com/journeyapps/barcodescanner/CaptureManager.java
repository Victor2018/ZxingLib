 ...
 */
public class CaptureManager implements OnZxingDecodeListener {
    ...
    private OnZxingDecodeListener mOnZxingDecodeListener;

    public void setOnZxingDecodeListener(OnZxingDecodeListener listener) {
        mOnZxingDecodeListener = listener;
    }
    ...
    public CaptureManager(Activity activity, DecoratedBarcodeView barcodeView) {
        ...
        barcodeView.getBarcodeView().setOnZxingDecodeListener(this);
    ...
    @Override
    public void OnZxingDecode(SourceData sourceData) {
        if (mOnZxingDecodeListener != null) {
            mOnZxingDecodeListener.OnZxingDecode(sourceData);
        }
    }
}
